+++
title = "6 Physical App Blockers Tested and Ranked (2026)"
slug = "physical-app-blockers-tested-ranked"
date = "2026-03-10"
description = "I tested and ranked six physical app blockers: Brick, PauseBox, Locked, Unpluq, Bloom, and Foqos. Here is what I found."
tags = [
    "Reviews",
    "Productivity",
]
...
<img src="media/brick_img.jpg" style="height:300px; object-fit:contain;">
...
<details>
<summary>Click to see how Emergency Unbrick works</summary>

![Brick](media/brick_unbrick.gif)
</details>

### How It Works
- **App is gray / dark** → Bricked Mode is **ON**, apps you select will be blocked.
...
<details>
<summary>Click to see how to Brick and Unbrick your phone</summary>
<div style="display:flex; gap:10px; flex-wrap:wrap;">
  <img src="media/turnOnbrick.gif" style="height:600px; object-fit:contain;">
  <img src="media/brick_modeOn.jpg" style="height:600px; object-fit:contain;">
  <div style="width:100%;">
...
- $59 price for the device.  
  <img src="media/brick_price.png" style="height:300px; object-fit:contain;">
- Requires creating an account, and some data is collected*, including:  
  ...
  *(See: https://getbrick.com/pages/privacy-policy)  
- It's not perfect; some users have reported issues on Android.

<!-- Callout suggestion:
{{< callout "note" >}}Brick requires a physical device to unlock. If you lose it or leave it at home, you're limited to emergency unlocks.{{< /callout >}}
-->

<h2>Here's What I Think About Brick</h2>
Rating:
...
<img src="media/brick_timeOn.jpg" style="height:300px; object-fit:contain;">
...
<div style="display:flex; gap:10px;">
  <img src="media/pausebox_img.jpg" style="height:300px; object-fit:contain;">
  <img src="media/pausetag_img.jpg" style="height:300px; object-fit:contain;">
</div>
...
<details>
<summary>Click to see how Emergency Unblock works</summary>
...
### How It Works
- **App is beige / cream color** → Pause Session is **OFF**, all apps work normally.
...
<details>
<summary>Click to see how to turn PauseBox on and off</summary>
<div style="display:flex; gap:10px; flex-wrap:wrap;">
...
<!-- Callout suggestion:
{{< callout "tip" >}}PauseBox and PauseTag are currently on sale — worth grabbing while the price is lower.{{< /callout >}}
-->

<h2>Here's What I Think About PauseBox</h2>
Rating:
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
...
<details>
<summary>Click to see Unpluq product images</summary>
<div style="display:flex; gap:10px; flex-wrap:nowrap;">
  <img src="media/unpluq_op.jpg" style="height:300px; object-fit:contain;">
  <img src="media/unpluq_tag2.jpg" style="height:300px; object-fit:contain;">
</div>
</details>
...
<details>
<summary>Click to see how to turn Unpluq on and off</summary>
<div style="display:flex; gap:10px; flex-wrap:wrap;">
...
<details>
<summary>Click to see Unpluq data collection details</summary>
<div style="display:flex; gap:10px; flex-wrap:wrap;">
...
<!-- Callout suggestion:
{{< callout "warning" >}}Unpluq is subscription-based at $66/year — there is no one-time purchase option.{{< /callout >}}
-->

<h2>Here's What I Think About Unpluq</h2>
Rating:
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
...
<img src="media/locked_tag.jpg" style="height:300px; object-fit:contain;">
...
<details>
<summary>Click to see how to use Locked</summary>
<div style="display:flex; gap:10px; flex-wrap:wrap;">
...
<!-- Callout suggestion:
{{< callout "tip" >}}Locked does not require an account and collects zero data — a great pick for privacy-conscious users.{{< /callout >}}
-->

<h2>Here's What I Think About Locked</h2>
Rating:
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
...
<img src="media/bloom_card.jpg" style="height:300px; object-fit:contain;">
...
<details>
<summary>Click to see Bloom app states</summary>
<div style="display:flex; gap:10px;">
  <img src="media/bloom_on.jpg" style="height:300px; object-fit:contain;">
  <img src="media/bloom_off.jpg" style="height:300px; object-fit:contain;">
</div>
</details>
...
<details>
<summary>Click to see how to turn Bloom on and off</summary>
<div style="display:flex; gap:10px; flex-wrap:wrap;">
...
<!-- Callout suggestion:
{{< callout "note" >}}Bloom includes a focus leaderboard — a unique feature not found in most competitors.{{< /callout >}}
-->

<h2>Here's What I Think About Bloom</h2>
Rating:
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
...
<img src="media/foqos_tags.jpg" style="height:300px; object-fit:contain;">
...
<details>
<summary>Click to see how to use Foqos</summary>
<div style="display:flex; gap:10px; flex-wrap:wrap;">
...
<!-- Callout suggestion:
{{< callout "tip" >}}Foqos is free and open source — the best option if you don't want to spend any money.{{< /callout >}}
-->

<h2>Here's What I Think About Foqos</h2>
Rating:
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
<span class="fa fa-star checked"></span>
